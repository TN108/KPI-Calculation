...
# # AssemblyAI configuration
aai.settings.api_key = "24bdf7cbedc44da8a1da42fdb426d405"

# Groq configuration
os.environ["GROQ_API_KEY"] = "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"
groq_client = Groq(api_key=os.environ["GROQ_API_KEY"])
...
# LLM for evaluation
HUGGINGFACE_API_TOKEN = os.getenv("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")
llm = pipeline(
    "text-generation",
...
def transcribe_with_diarization_whisperx(audio_path, min_speakers=2, max_speakers=2, model_name="base"):
    ...
    try:
        ...
        diarize_model = whisperx.diarize.DiarizationPipeline(
            use_auth_token="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",
            device=device
        )
